	...
	question: (
		<div className="relative inline-flex items-center justify-center bg-gradient-to-br from-lime-50 to-green-100 text-lime-600 rounded-2xl w-14 h-14 shadow-lg mb-4 group-hover:shadow-xl transition-all duration-300 group-hover:scale-110">
			...
			>
				...
				<text x="9" y="12.5" fontSize="6" fill="currentColor" fontWeight="bold">
					?
				</text>
			</svg>
		</div>
...
const features = [
	{
		...
		description:
			"Experience world-class, explainable feedback for every answer. Built for trust, not surprises.",
	...
	},
	{
		...
		description:
			"See how focused and confident you appear during practice—nail your first impression, live.",
	...
	},
	{
		...
		icon: icons.question,
		description:
			"Get spot-on, targeted questions in seconds. Simply pick a company, topic, or upload your resume.",
		highlight: "Instant",
	},
	{
		...
		icon: icons.study,
		description:
			"Create, save, and follow tracks tailored to your goals. Bookmark tough questions for review.",
	...
	},
	{
		...
		icon: icons.company,
		description:
			"Practice questions and rounds that match real recruiter styles at 50+ top tech companies.",
	...
	},
	{
		...
		description:
			"Visualize your strengths, see trends, and celebrate every milestone. Analytics made beautiful.",
