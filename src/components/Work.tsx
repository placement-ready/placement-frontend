							...
							<div className="relative transform group-hover:-translate-y-2 transition-all duration-500 ease-out">
								...
								<div className="bg-white/80 backdrop-blur-xl rounded-2xl p-6 shadow-xl border border-white/50 group-hover:shadow-2xl transition-all duration-500">
									...
									<div className="relative mx-auto mb-6 w-16 h-16 flex items-center justify-center">
										{/* Outer glow ring */}
										<div
											className={`absolute inset-0 bg-gradient-to-r ${step.bgGradient} rounded-full opacity-20 scale-110 group-hover:scale-125 transition-transform duration-500 ${step.glowColor} shadow-xl`}
										></div>

										{/* Main circle */}
										<div
											className={`relative w-full h-full bg-gradient-to-r ${step.bgGradient} rounded-full flex items-center justify-center shadow-lg group-hover:shadow-xl transition-all duration-300 group-hover:scale-110`}
										>
											{/* Number */}
										...
										<div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
											<div
												className={`absolute -top-2 -right-2 w-2 h-2 ${step.accentColor} rounded-full animate-ping`}
											></div>
											<div
												className={`absolute -bottom-2 -left-2 w-1.5 h-1.5 ${step.accentColor} rounded-full animate-ping delay-300`}
											></div>
										</div>
									</div>
									{/* Content */}
									<div className="text-center">
										<h3
											className={`text-lg sm:text-xl font-bold text-gray-900 mb-4 group-hover:${step.textColor} transition-colors duration-300`}
										>
											{step.title}
										</h3>
										...
										<div className="flex justify-center">
											<div className={`w-10 h-1 ${step.lightBg} rounded-full overflow-hidden`}>
												<div
													className={`h-full bg-gradient-to-r ${step.bgGradient} rounded-full transform scale-x-0 group-hover:scale-x-100 transition-transform duration-700 delay-200`}
												></div>
											</div>
										</div>
									</div>
