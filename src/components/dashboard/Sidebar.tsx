...
const links = [
    ...
    { name: "Roadmap", icon: MdEventNote, href: "/dashboard/roadmap" } // Fixed here
];
        ...
        <>
            ...
            <aside
                ...
                className={`
                    ...
                    ${isMobile ? "top-0 left-0 h-full" : "top-4 h-[calc(100vh-2rem)]"}
                    ...
                    rounded-2xl shadow-xl shadow-green-500/10
                    flex flex-col
            ...
            >
                ...
                <div
                    className={`
                        ${isOpen ? "w-full mb-8 px-4 py-3" : "w-12 mb-6 px-3 py-3"}
