...
import {
  User, Mail, Phone, MapPin, Globe, Briefcase, GraduationCap, Award, Sparkles, Plus, X, Download, Play, Loader2
} from 'lucide-react';
...
// Move memoized components outside to prevent re-creation
...
const ExperienceSection = React.memo<{
  experience: Experience[];
  updateExperience: (id: number, field: keyof Experience, value: any) => void;
  addExperience: () => void;
...
const PreviewPlaceholder = React.memo<{
  ...
  <div className="h-full flex items-center justify-center bg-gray-50">
    <div className="text-center">
      ...
      <p className="text-sm text-gray-500 mb-4">Click "Compile Resume" to generate your preview</p>
      <button 
...
const ResumeBuilder: React.FC = () => {
  ...
  const compileResume = useCallback(async () => {
    setIsCompiling(true);
    // Simulate compilation time (you can remove this delay if not needed)
    await new Promise(resolve => setTimeout(resolve, 1500));
    setShowPreview(true);
    setIsCompiling(false);
  }, []);

  // Update functions that DON'T hide preview - only compilation triggers preview changes
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      {/* Simple Navbar since we don't have the component */}
            ...
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="flex items-center gap-3">
                <button 
                  onClick={compileResume}
                  disabled={isCompiling}
                  className="flex items-center gap-2 py-2 px-4 text-sm font-semibold rounded-lg text-white bg-blue-600 hover:bg-blue-700 disabled:bg-blue-400 transition-colors"
                >
                  {isCompiling ? (
                    <>
                      <Loader2 size={16} className="animate-spin" /> Compiling...
                ...
                <button 
                  ...
                  className="flex items-center gap-2 py-2 px-4 text-sm font-semibold rounded-lg text-white bg-green-600 hover:bg-green-700 disabled:bg-gray-400 transition-colors"
                >
